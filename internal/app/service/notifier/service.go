...
// UpdateChassisList updates the list of car body types.
func (s *Service) UpdateChassisList(ctx context.Context) error {
...
// UpdateRegionsList updates the list of regions.
func (s *Service) UpdateRegionsList(ctx context.Context) error {
